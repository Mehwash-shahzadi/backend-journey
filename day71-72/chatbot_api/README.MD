# AI Chatbot Backend with Persistent Storage & AI Features

A production-ready chatbot backend built over Days 69-72. Features conversation management, message history, intelligent context trimming, real-time streaming - all stored in PostgreSQL. Plus 4 powerful AI endpoints for summarization, content moderation, text classification, and text generation!

## What This Does

A complete backend for a ChatGPT-like application with:

**Days 69-70 - Chat Features:**
...
**Days 71-72 - AI-Powered Features (NEW!):**

- Text summarization (reduces to ~100 characters)
- Content moderation (toxicity detection)
- Text classification (categorize + sentiment)
- Template-based text generation (email, blog, product)

## Features

**Conversation Management (Days 69-70):**
...
**AI Text Processing (Days 71-72) - NEW!:**
...
```
day71-72/chatbot_api/
├── main.py                   # FastAPI application (includes both routers)
├── database.py               # Database connection
├── config.py                 # Settings (context limits, etc.)
├── models.py                 # Database models
├── dependencies.py           # FastAPI dependencies
├── crud.py                   # Database operations
├── routers/
│   ├── chat.py              # Days 69-70: Chat endpoints
│   └── ai_features.py       # Days 71-72: AI endpoints (NEW!)
├── services/
│   ├── gemini_service.py    # Google Gemini API integration
│   └── ai_utils.py          # Redis caching + prompt templates (NEW!)
├── schemas/
│   ├── conversation.py      # Request/response models for chat
...
- **Text processing pipelines** (summarization, classification)
- **Content safety** (moderation/toxicity detection)
- **Template-based generation** for bulk content creation
- **Async Redis operations** in Python
- **SHA256 cache key generation** for uniqueness
